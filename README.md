...
Edit: I also added Goroutine capability. I plan to expand on this later. The reason I added this, certain requests we don't really care about waiting for the response. We can just submit these and then go onto to subsequent requests to save time. If the previous requests fail they will be caught later and raise a panic. In future this will force a complete task restart.
<details>
